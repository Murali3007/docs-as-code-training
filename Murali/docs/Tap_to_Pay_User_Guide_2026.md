...
-   [**For iOS Device:**] During the first Tap to Pay transaction     on the device, the user is prompted to provide consent to enable Tap to Pay with the registered Apple ID.
